...
public final class MecanumDrive {
    public static class Params {
        ...
        public double inPerTick = 0.001945737;
        public double lateralInPerTick = 0.0016204249601300482;
        public double trackWidthTicks = 4795.61215108; // (9.331 in)

        // feedforward parameters (in tick units)
        public double kS = 1.067552574524715;
        public double kV = 0.0003654907854272816;

...
@Config
@Autonomous(name = "CompetitionAutoRedFar", group = "Autonomous")
public class CompetitionAutoRedFar extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectoryActionBuilder traj1 = drive.actionBuilder(initialPose)
                .strafeToSplineHeading(new Vector2d(55, 10), Math.toRadians(153));
        ...
        Action trajectoryActionCloseOut = traj3.endTrajectory().fresh()
                .strafeToSplineHeading(new Vector2d(55, 10), Math.toRadians(158))
                .build();
